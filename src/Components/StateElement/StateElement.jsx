...
import {
  ...
  StateIconHeating,
  StateIconHumidity,
} from "dr066-ba-development-system";
...
export function StateElement({ state, detail }) {
  ...
  function getLightTemplate(state) {
    return (
      <StateIconContainer>
        <StateIconLight state={state.value}></StateIconLight>
      </StateIconContainer>
    );
  }
  ...
  function getCameraTemplate(state) {
    return (
      <StateIconContainer>
        <StateIconCamera state={state.value == "An"}></StateIconCamera>
      </StateIconContainer>
    );
  }
  ...
  function getGarageTemplate(state) {
    return (
      <StateIconContainer>
        <StateIconGarage state={state.value}></StateIconGarage>
      </StateIconContainer>
    );
  }
  ...
  function getHeatingTemplate(state) {
    ...
    return (
      <StateIconContainer>
        <StateIconHeating state={computed}></StateIconHeating>
      </StateIconContainer>
    );
  }
  ...
  function getHumidityTemplate(state) {
    return (
      <StateIconContainer>
        <StateIconHumidity state={state.value}></StateIconHumidity>
      </StateIconContainer>
    );
  }
  ...
  return (
    <section className='flex flex-col items-center'>
      ...
      {detail && (
        <p>
          <Text colorClass='gray-500'>
            {state.devices} {state.string}
          </Text>
        </p>
      )}
      <p></p>

...
export function DeviceElement({ device, callback }) {
  ...
  function getValueTemplate(attribute) {
    return (
      <ValueElement attribute={attribute.name}>
  ...
  return (
    <section className='flex'>
        ...
        <div className='my-auto'>
          <DeviceIconContainer>
            <DeviceIcon
              ...
              colorClass={deviceState.disabled ? "disabled" : deviceState.cube}
              outline={deviceState.state === false}
            />
          </DeviceIconContainer>
        </div>
      ...
      <div className='bg-gray-300 border border-black rounded-r-sm'>
        <Link
          to={{ pathname: useLocation().pathname, search: "popUp=true" }}
